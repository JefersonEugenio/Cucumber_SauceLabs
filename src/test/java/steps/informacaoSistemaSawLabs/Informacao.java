...
public class Informacao {
    ...
    public void oUsuárioPreencheOCampoFirstNameCom(String nome) {
    ...
    public void oUsuárioPreencheOCampoLastNameCom(String sobrenome) {
    ...
    public void oSistemaDeveráRedirecionarParaATelaDo(String titulo) throws IllegalAccessException {
        String title = driver.findElement(By.cssSelector(".subheader")).getText();
        assertThat(title, containsString(titulo));
